...
namespace IMX.ATS.ATEConfig
{
    ...
    public static class SupportConfig
    {
        ...
        ///// <summary>
        ///// 三相支持的试验项配置字典[试验项名称, 数据库存储信息]
        ///// </summary>
        //public static Dictionary<string, ProcessConfig_EX> DicProcessConfig_Three => new Dictionary<string, ProcessConfig_EX>();
        
        ///// <summary>
        ///// 逆变支持的试验项配置字典[试验项名称, 数据库存储信息]
        ///// </summary>
        //public static Dictionary<string, ProcessConfig_EX> DicProcessConfig_In => new Dictionary<string, ProcessConfig_EX>();
    }
