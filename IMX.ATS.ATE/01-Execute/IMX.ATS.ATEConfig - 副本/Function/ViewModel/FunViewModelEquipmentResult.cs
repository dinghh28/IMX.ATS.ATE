    ...
    public class FunViewModelEquipmentResult : FunViewModel
    {
        ...
        public override TestFunction Func 
        {
            ...
            set 
            {
                ...
                var datanames = SupportDeviceInfo.DicDeviceDataInfos[EDeviceType.Acquisition]?.RecData.ToDictionary(x => x.DataInfo.Name)?.Keys.ToList();
                if (GlobalModel.NowElectricity == ATE.Common.Electricity.Three)
                {
                    datanames.AddRange(SupportDeviceInfo.DicDeviceDataInfos[EDeviceType.Acquisition]?
                        .DicDeviceDataEX["AN87600"]
                        .RecData_Ex
                        .ToDictionary(x => x.DataInfo.Name)?
                        .Keys
                        .ToList());
                }
