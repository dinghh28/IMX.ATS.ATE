...
{
    public class ResultStringColorConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ResultState result = (ResultState)value;
            SolidColorBrush brush = Brushes.Black;

            brush = result == ResultState.SUCCESS ? Brushes.Green : result == ResultState.FAIL ? Brushes.Red : Brushes.Black;
